  ...
  <body>
      <div class="container">
        <div class="page-header">
          <h1><center>Popular Name Database</center></h1>
        </div>
...
<div class="row">
    <div class="col-md-12">
       ...
       echo "
       <div class='col-md-12'>
       <center><h3>Popular Votes<h3></center>" . PHP_EOL;
      ...
      <div class="row">
          <div class="col-md-12">
              <div id="content-one"  class="data-one alert alert-success">
                   ...
                   <h1>Girls Names 2015</h1>" . PHP_EOL;
                   if($result4->num_rows > 0) {
              ...
              <div class="col-md-12">
                  ...
                  if($result->num_rows > 0) {
                    ...
                    echo '         </tbody> </table> </div>' . PHP_EOL;
                     ...
                     echo "<div class='col-md-6 col-sm-12'>
                     <h1>Girls Names 2005</h1>" . PHP_EOL;
          ...
          <div class="row">
              <div class="col-md-12">
                  <div id="content-three"  class="data-one alert alert-success">
                       ...
                       echo "<div class='col-md-6 col-sm-12'>
                       <h1>Girls Names 1995</h1>" . PHP_EOL;
